...
本仓库只用于发布安装包，不包含客户端源码。

## 最新版本

版本：1.0.2

Windows 当前构建：取消 Codex 聊天记录恢复前的原生确认弹窗，点击立即恢复后直接进入自动备份和恢复流程。

### Windows 10 / Windows 11

下载安装包：

[Windows x64 安装包，点击直接下载](https://raw.githubusercontent.com/binF00/jieyouai-desktop-releases/main/downloads/1.0.2/jieyouai-desktop-1.0.2-win-x64-setup.exe)

备用链接：

[打开 GitHub 文件页](downloads/1.0.2/jieyouai-desktop-1.0.2-win-x64-setup.exe)

校验文件：

[SHA256SUMS.txt](downloads/1.0.2/SHA256SUMS.txt)
...
SHA256 用于确认下载的安装包没有损坏或被替换。普通用户可以忽略；测试或分发时可用于核对文件一致性。
